...
class Cube3DModeData : GDModeData() {
    ...
    override fun tickInput(input: Input) {
        this.gdData?.run {
            if (this.player.onGround()) {
                this@Cube3DModeData.targetCubeRot = Math.round(this@Cube3DModeData.targetCubeRot / 90F) * 90F
            } else {
                this@Cube3DModeData.targetCubeRot += 20F
            }
        }
    }
